...
export default function AboutUs() {
    const reviews = [
        {
            id: 1,
            text: "Sweet Organics is my go-to for refreshing, natural energy! The Orange Juice is unmatched.",
        ...
        <section id="about" className={theme === "light" ? "about-section" : "dark-about-section"}>
            <div className="about-container">
                <div className="about-header">
                    <h2>About Sweet Organics</h2>
                    <div className="story-container">
                        <div className="story-text">
                            <h3>Our Story</h3>
                            <p>
                                Founded in 2010, Sweet Organics started with a simple mission: to make fresh, organic juice accessible to everyone. What began in a small kitchen has grown into a community staple, but our values remain the same. We believe in the power of nature to nourish and energize.
                            </p>
                            <h3>Our Mission</h3>
                            <p>
