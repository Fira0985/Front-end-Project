        ...
        <section className={theme === "light"? "hero-section": "dark-hero-section"}>
            <div className="hero-container">
                <div className="hero-content">
                    <h1>Sweet Organics</h1>
                    <h3>Nature's Finest, Bottle for You</h3>
                    <p>Experience the pure essence of organic fruits with Sweet Organics. No additives, no preservatives—just 100% natural goodness delivered to your doorstep or ready for pickup.</p>
